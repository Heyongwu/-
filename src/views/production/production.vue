  ...
  <div class="layout">
    <Layout :style="{minHeight: '100'}">
      <Sider collapsible :collapsed-width="78" v-model="isCollapsed">
        ...
        <Menu theme="dark" width="auto" :class="menuitemClasses" active-name="operate">
          <router-link to="/home/production/operate">
            <menu-item name="operate">
  ...
  export default {
    ...
    mounted() {
      if(common.isTokenUndefined(this) == false){
        ...
        this.$router.push('/home/production/operate')
        // 获取浏览器可视区域高度
