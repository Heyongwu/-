  ...
  <div class="layout">
    <Layout :style="{minHeight: '100'}">
      <Sider collapsible :collapsed-width="78" v-model="isCollapsed">
        ...
        <Menu theme="dark" width="auto" :class="menuitemClasses" active-name="orderConfirm">
          <router-link to="/home/delivery/management">
            <menu-item name="orderConfirm">
      ...
      <Layout>
        ...
        <Content :style="{padding: '0 16px 16px'}">
          <Breadcrumb :style="{margin: '16px 0'}">
            ...
            <BreadcrumbItem>送货管理</BreadcrumbItem>
          </Breadcrumb>
          <Card>
            <div ref="homePage">
              <router-view/>
  ...
  export default {
    ...
    mounted() {
      if (common.isTokenUndefined(this) == false) {
        ...
        this.$router.push('/home/delivery/management')
        // }
        // 获取浏览器可视区域高度
